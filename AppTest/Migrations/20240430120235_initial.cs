        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultInt = table.Column<int>(type: "int", nullable: false),
                    ResultString = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_UserPages_UserPageId",
            ...
            migrationBuilder.CreateTable(
                name: "AnswerEntityTestResultEntity",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerEntityTestResultEntity", x => new { x.AnswersId, x.ResultsId });
                    table.ForeignKey(
                        name: "FK_AnswerEntityTestResultEntity_Answers_AnswersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentEntityImageEntity", x => new { x.CommentsId, x.ImagesId });
                    table.ForeignKey(
                        name: "FK_CommentEntityImageEntity_Comments_CommentsId",
                        column: x => x.CommentsId,
                        principalTable: "Comments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentEntityImageEntity_Images_ImagesId",
                        column: x => x.ImagesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageEntityPostEntity", x => new { x.ImagesId, x.PostsId });
                    table.ForeignKey(
                        name: "FK_ImageEntityPostEntity_Images_ImagesId",
                        column: x => x.ImagesId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImageEntityPostEntity_Posts_PostsId",
                        column: x => x.PostsId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerEntityTestResultEntity_ResultsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentEntityImageEntity_ImagesId",
                table: "CommentEntityImageEntity",
                column: "ImagesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageEntityPostEntity_PostsId",
                table: "ImageEntityPostEntity",
                column: "PostsId");
